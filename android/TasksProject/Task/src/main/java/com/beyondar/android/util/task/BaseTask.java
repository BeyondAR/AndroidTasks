...
//	public static final int TASK_TYPE_TIMER = TASK_TYPE_NORMAL + 1;
     ...
     *
     * @param run set tru to allow the task to run in the background
     */
     ...
     *
     * @return tru if can run in background, false otherwise
     */
    ...
    public TaskResult executeTask() {
        ...
        if (AnnotationsUtils.hasUiAnnotation(this, RunnableTask.__RUN_TASK_METHOD_NAME__)) {
        ...
        if (AnnotationsUtils.hasUiAnnotation(this, OnFinishTask.__ON_FINISH_METHOD_NAME__)) {
     ...
     *
     * @param id The task to wait before continue executing this task
     ...
     *
     * @param outputCode The error code. See {@link TaskResult} variables
     */
