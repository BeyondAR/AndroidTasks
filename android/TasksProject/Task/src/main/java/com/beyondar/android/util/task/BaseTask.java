 ...
 * 
 */
public abstract class BaseTask implements TaskStub{
	...
	/**
	 * Get the BaseTask type: <br>
	 * - TASK_TYPE_NORMAL --> BaseTask to execute using the FIFO queue <br>
	 * - TASK_TYPE_TIMER --> BaseTask to execute using the timer queue
	 * 
	 * @return
	 */
